...
class PathTools:
    ...
    @staticmethod
    def path_of_category(storage_path: str, category: str):
        """
        @param storage_path: The path where all files should be stored.
        @param category: The name of the category where the page is located.
        @return: A path where the file should be saved.
        """
        path = str(Path(storage_path) / PathTools.to_valid_name(category))
        return path

    @staticmethod
    def path_of_download_category(storage_path: str, category: str):
        """
        @param storage_path: The path where all files should be stored.
        @param category: The name of the category where the page is located.
        @return: A path where the file should be saved.
        """
        path = str(Path(storage_path).absolute() / 'Downloads' / PathTools.to_valid_name(category))
        return path

    @staticmethod
    def path_of_download_book(storage_path: str, category: str, book_title: str):
        """
        @param storage_path: The path where all files should be stored.
        @param category: The name of the category where the page is located.
        @param book_title: Title of the book link.
        @return: A path where the file should be saved.
        """
        path = str(
            Path(storage_path).absolute()
            / 'Downloads'
            / PathTools.to_valid_name(category)
            / PathTools.to_valid_name(book_title)
        )
        return path

    @staticmethod
    def path_of_download_description(storage_path: str, category: str, book_title: str):
        """
        @param storage_path: The path where all files should be stored.
        @param category: The name of the category where the page is located.
        @param book_title: Title of the book link.
    ...
    @staticmethod
    def path_of_download_folder(storage_path: str, category: str):
        """
        @param storage_path: The path where all files should be stored.
        @param category: The name of the category where the page is located.
        @return: A path where the file should be saved.
